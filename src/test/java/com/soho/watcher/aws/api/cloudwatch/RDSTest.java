...
public class RDSTest {
	...
	//
	private String namespace = "AWS/RDS";
	private String dimensionName = "DBInstanceIdentifier";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("seoul-dev-bespinam-mariadb01");
	//	dimension.setValue("csjauroratest");
	//	dimension.setValue("testwatcherdb");
