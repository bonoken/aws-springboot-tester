...
public class LogsTest {
	...
	//
	private String namespace = "AWS/Logs";
	private String dimensionName = "LogGroupName";
	...
	public void getMetricStatistic(){
		...
		//dimension.setValue("/aws/rds/instance/seoul-dqa-lightsaber-alarm-db01/error");
		dimension.setValue("SEOUL-DEV-BESPIN-VPC-LOG");
