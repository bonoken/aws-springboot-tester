...
@SpringBootTest
public class EC2EBSTest {
	
	/** log */
	private static final Logger logger = LogManager.getLogger(EC2EBSTest.class);
	...
	//
	private String namespace = "AWS/EBS";
	private String dimensionName = "VolumeId";
