...
public class KinesisTest {
	...
	/** log */
	private static final Logger logger = LogManager.getLogger(KinesisTest.class);
	...
	//
	private String namespace = "AWS/Kinesis";
	private String dimensionName = "StreamName";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("SEOUL-DQA-OPSNOW-ALERT");
