...
@SpringBootTest
public class EC2AutoScalingTest {

	/** log */
	private static final Logger logger = LogManager.getLogger(EC2AutoScalingTest.class);
	...
	private String dimensionName = "AutoScalingGroupName";
	...
	public void getMetricStatistic(){
		...
		// dimension.setValue("auto-group-kang");
		dimension.setValue("LYS-AUTOSCALE-GI-AUTO_2");
