...
@SpringBootTest
public class IOTRuleTest {
	
	//https://docs.aws.amazon.com/ko_kr/AmazonCloudWatch/latest/monitoring/iot-metricscollected.html
	
	/** log */
	private static final Logger logger = LogManager.getLogger(IOTRuleTest.class);
	...
	public void getMetricStatistic(){
		...
		for (String metricNm : metricList) {
			...
			if("Success".equals(metricNm) || "Failure".equals(metricNm)) {
