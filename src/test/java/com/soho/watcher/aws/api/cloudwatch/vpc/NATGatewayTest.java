...
public class NATGatewayTest {
	...
	/** log */
	private static final Logger logger = LogManager.getLogger(NATGatewayTest.class);
	...
	//
	private String namespace = "AWS/NATGateway";
	private String dimensionName = "NatGatewayId";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("nat-074af8292113a8403");
