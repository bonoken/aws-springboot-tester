...
public class CloudFrontTest {
	...
	//
	private String namespace = "AWS/CloudFront";
	private String dimensionName = "DistributionId";
	
	@Test
	public void contextLoads()  {
		
		// Region은 us-east-1 고정
		AwsClientFactory factory = new AwsClientFactory(config);
		AmazonCloudWatch cw = factory.cloudWatchClient("us-east-1");
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("E2R1I05GWRVJYJ");
		...
		for (String metricNm : metricList) {
			...
			//request.setMetricName("Requests");
			...
			Dimension basic = new Dimension();
			basic.setName("Region");
			basic.setValue("Global");
			dimensions.add(basic);
