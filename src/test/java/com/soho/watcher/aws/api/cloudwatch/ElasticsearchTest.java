...
public class ElasticsearchTest{
	...
	//
	private String namespace = "AWS/ES";
	private String dimensionName = "DomainName";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("ent-test");

		//dimension.setName("ClientId");
		//dimension.setValue("923247590277");
		...
		for (String metricNm : metricList) {
			...
			d.setName("ClientId");
			d.setValue("367072688873");
			
			dList.add(dimension);
			dList.add(d);

			request.withDimensions(dList);
