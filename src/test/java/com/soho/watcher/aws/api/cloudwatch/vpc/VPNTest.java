...
public class VPNTest {
	...
	/** log */
	private static final Logger logger = LogManager.getLogger(VPNTest.class);
	...
	//
	private String namespace = "AWS/VPN";
	private String dimensionName = "TunnelIpAddress";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("13.124.164.229");
