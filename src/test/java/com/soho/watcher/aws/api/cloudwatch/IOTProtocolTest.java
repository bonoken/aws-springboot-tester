...
@SpringBootTest
public class IOTProtocolTest {

	/** log */
	private static final Logger logger = LogManager.getLogger(IOTProtocolTest.class);
	...
	private String dimensionName = "Protocol";
