...
public class SNSTest {
	...
	/** log */
	private static final Logger logger = LogManager.getLogger(SNSTest.class);
	...
	//
	private String namespace = "AWS/SNS";
	private String dimensionName = "TopicName";
