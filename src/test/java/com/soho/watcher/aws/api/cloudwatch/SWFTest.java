...
public class SWFTest {
	...
	/** log */
	private static final Logger logger = LogManager.getLogger(SWFTest.class);
	...
	//
	private String namespace = "AWS/SWF";
	private String dimensionName = "APIName";
	...
	public void getMetricStatistic(){
		...
		dimension.setValue("DescribeDomain");
